...
INSERT INTO `uporabnik` (`id_uporabnik`, `tip`, `davcna_stevilka`, `email`, `emso`, `geslo`, `ime`, `priimek`, `spremenjeno`, `uporabnisko_ime`, `ustvarjeno`, `zadnja_prijava`) VALUES
  ...
  (50, 'Student', NULL, 'primoz.hrovat@gmx.com', NULL, '$31$16$irG9VKXkRV0pxhGRhYZWDZZGO71V--R5_sLsBOWPUWI', 'Luka', 'Kovač', NULL, 'lk3317', '2018-04-05 21:10:56', NULL);
...
INSERT INTO `student` (`id_uporabnik`, `drzava_rojstva`, `kraj_rojstva`,
  ...
  (31, NULL, NULL, 'Ljubljanska cesta 15b', NULL, NULL, '070123123', 63150001, NULL, NULL, NULL, NULL, 'Novomeška 1'),
...
INSERT INTO vpis (student, studijsko_leto, letnik, nacin_studija, oblika_studija, studijski_program, vrsta_vpisa) VALUES
  (31, 2015, 1, 1, 1, 1000468, 1),
  (32, 2015, 1, 1, 1, 1000468, 1),
  (32, 2016, 1, 1, 1, 1000468, 1),
  (33, 2015, 2, 1, 1, 1000468, 1),
  (34, 2015, 1, 1, 1, 1000470, 1),
  (35, 2015, 1, 1, 1, 1000471, 1),
  (36, 2015, 1, 1, 1, 1000468, 1),
  (36, 2016, 2, 1, 1, 1000468, 1),
  (37, 2016, 1, 2, 2, 1000470, 1),
  (37, 2017, 2, 2, 2, 1000470, 1),
  (37, 2018, 2, 2, 2, 1000470, 2);
