...
VALUES
  ...
  (null, null, null, 63225, 2016),
  (15, null, null, 63242, 2016),
  (null, null, null, 63284, 2016),
...
INSERT INTO izpit (datum, koncna_ocena, ocena_pisno, ocena_ustno, student, predmet, zap_st_polaganja, prijava_id) VALUES
  /* nevpisan student */
  ('2017-06-08', 5, 0, 0, 58, 63202, 1, 2),
  ('2017-06-28', 5, 0, 0, 58, 63202, 2, 3),
  ('2017-09-03', 5, 0, 0, 58, 63202, 3, 4),
  ('2018-06-10', 5, 0, 0, 58, 63202, 1, 5),
  ('2018-06-22', 5, 0, 0, 58, 63202, 2, 6),
  ('2018-09-05', 5, 0, 0, 58, 63202, 3, 7),

  /* ponavljalec 1. letnik */
  ('2018-06-08', 5, 0, 0, 52, 63203, 1, 8),
  ('2018-06-09', 5, 0, 0, 52, 63277, 1, 9),
  ('2018-06-10', 5, 0, 0, 52, 63202, 1, 10),
  ('2018-06-09', 5, 0, 0, 52, 63204, 1, 11),
  ('2018-06-12', 6, 0, 0, 52, 63205, 1, 12),
  ('2018-06-13', 6, 0, 0, 52, 63278, 1, 13),
  ('2018-06-15', 7, 0, 0, 52, 63212, 1, 14),
  ('2018-06-16', 8, 0, 0, 52, 63209, 1, 15),
  ('2018-06-15', 6, 0, 0, 52, 63215, 1, 16),
