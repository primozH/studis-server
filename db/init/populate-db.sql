...
VALUES
  ...
  ('L1', 'Računalništvo in infomatika MAG 2.st', 1000471, 4, 3, 17003),
...
INSERT INTO vpis (student, studijsko_leto, letnik, nacin_studija, oblika_studija, studijski_program, vrsta_vpisa, potrjen) VALUES
  ...
  (54, 2015, 1, 1, 1, 1000468, 1, 1),
  (54, 2016, 2, 1, 1, 1000468, 1, 1),
  (54, 2017, 3, 1, 1, 1000468, 1, 1),
  (54, 2018, 1, 1, 1, 1000471, 1, 1),
  (55, 2013, 1, 1, 1, 1000470, 1, 1),
  (55, 2014, 2, 1, 1, 1000470, 1, 1),
  (55, 2015, 3, 1, 1, 1000470, 1, 1),
  (55, 2016, 1, 1, 1, 1000471, 1, 1),
  (55, 2017, 2, 1, 1, 1000471, 1, 1),
  (55, 2018, 1, 1, 1, 1000474, 1, 1),
  ...
  (59, 2017, 1, 1, 1, 1000468, 1, 1),
  (59, 2018, 2, 1, 1, 1000468, 1, 1),
  (61, 2016, 1, 1, 1, 1000468, 1, 1),
  (61, 2017, 2, 1, 1, 1000468, 1, 1),
  (61, 2018, 3, 1, 1, 1000468, 1, 1),
  (62, 2016, 1, 1, 1, 1000468, 1, 1),
  (62, 2017, 2, 1, 1, 1000468, 1, 1),
  (62, 2018, 3, 1, 1, 1000468, 1, 1),
  (63, 2017, 1, 1, 1, 1000470, 1, 1),
  (64, 2014, 1, 1, 1, 1000468, 1, 1),
  (64, 2015, 2, 1, 1, 1000468, 1, 1),
  (64, 2016, 3, 1, 1, 1000468, 1, 1),
  (64, 2017, 1, 1, 1, 1000471, 1, 1),
  (64, 2018, 2, 1, 1, 1000471, 1, 1);
...
VALUES
  ...
  (40, null, null, 63269, 2017),
  (null, null, null, 63225, 2017),
  (15, null, null, 63242, 2017),
  (null, null, null, 63284, 2017),
...
VALUES
  ...
  /* ponavljalec */
  ('2018-06-02', NULL, 'P01', 24, 2017, 63203),
  ('2018-06-03', NULL, 'P01', 24, 2017, 63277),
  ('2018-06-04', NULL, 'P01', 24, 2017, 63202),
  ('2018-06-05', NULL, 'P01', 24, 2017, 63204),
  ('2018-06-08', NULL, 'P01', 24, 2017, 63205),
  ('2018-06-09', NULL, 'P01', 24, 2017, 63278),
  ('2018-06-10', NULL, 'P01', 24, 2017, 63212),
  ('2018-06-11', NULL, 'P01', 24, 2017, 63209),
  ('2018-06-12', NULL, 'P01', 24, 2017, 63215),
  ('2018-06-13', NULL, 'P01', 24, 2017, 63207),
...
INSERT INTO prijava_rok (cas_prijave, studijsko_leto, student, predmet, datum_izvajanja, brisana) VALUES
  ...
  (CURRENT_DATE, 2017, 58, 63202, '2018-06-04', FALSE),
  (CURRENT_DATE, 2017, 58, 63202, '2018-06-18', FALSE),
  (CURRENT_DATE, 2017, 58, 63202, '2018-09-01', FALSE),

  /* ponavljalec 1. letnik */
  ('2018-07-31', 2017, 52, 63203, '2018-06-02', FALSE),
  ('2018-06-01', 2017, 52, 63277, '2018-06-03', FALSE),
  ('2018-06-01', 2017, 52, 63202, '2018-06-04', FALSE),
  ('2018-06-01', 2017, 52, 63204, '2018-06-05', FALSE),
  ('2018-06-01', 2017, 52, 63205, '2018-06-08', FALSE),
  ('2018-06-01', 2017, 52, 63278, '2018-06-09', FALSE),
  ('2018-06-01', 2017, 52, 63212, '2018-06-10', FALSE),
  ('2018-06-01', 2017, 52, 63209, '2018-06-11', FALSE),
  ('2018-06-01', 2017, 52, 63215, '2018-06-12', FALSE),
  ('2018-06-01', 2017, 52, 63207, '2018-06-13', FALSE),
...
INSERT INTO izpit (datum, koncna_ocena, ocena_pisno, ocena_ustno, studijsko_leto, student, predmet, datum_izvajanja, zap_st_polaganja) VALUES
  ...
  ('2018-06-10', 5, 0, 0, 2017, 58, 63202, '2018-06-04', 1),
  ('2018-06-22', 5, 0, 0, 2017, 58, 63202, '2018-06-18', 2),
  ('2018-09-05', 5, 0, 0, 2017, 58, 63202, '2018-09-01', 3),

  /* ponavljalec 1. letnik */
  ('2018-06-08', 5, 0, 0, 2017, 52, 63203, '2018-06-02', 1),
  ('2018-06-09', 5, 0, 0, 2017, 52, 63277, '2018-06-03', 1),
  ('2018-06-10', 5, 0, 0, 2017, 52, 63202, '2018-06-04', 1),
  ('2018-06-09', 5, 0, 0, 2017, 52, 63204, '2018-06-05', 1),
  ('2018-06-12', 6, 0, 0, 2017, 52, 63205, '2018-06-08', 1),
  ('2018-06-13', 6, 0, 0, 2017, 52, 63278, '2018-06-09', 1),
  ('2018-06-15', 7, 0, 0, 2017, 52, 63212, '2018-06-10', 1),
  ('2018-06-16', 8, 0, 0, 2017, 52, 63209, '2018-06-11', 1),
  ('2018-06-15', 6, 0, 0, 2017, 52, 63215, '2018-06-12', 1),
  ('2018-06-18', 6, 0, 0, 2017, 52, 63207, '2018-06-13', 1),

  ('2018-07-01', 5, 0, 0, 2017, 52, 63277, '2018-06-22', 2),

  ('2019-06-12', 6, 0, 0, 2018, 52, 63277, '2019-06-05', 1)
;
