...
CREATE TABLE IF NOT EXISTS `izpit` (
  ...
  `izprasevalec` int(11) DEFAULT NULL,
  ...
  KEY `FK_izpit_uporabnik` (`izprasevalec`),
  KEY `izpit_student_id_uporabnik_fk` (`student`),
  CONSTRAINT `FK_izpit_studijsko_leto` FOREIGN KEY (`prijava_id`) REFERENCES `prijava_rok` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `FK_izpit_uporabnik` FOREIGN KEY (`izprasevalec`) REFERENCES `uporabnik` (`id_uporabnik`),
...
CREATE TABLE IF NOT EXISTS `izpitni_rok` (
  ...
  `predmet` int(11) NOT NULL,
  `zakljucen` tinyint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=129 DEFAULT CHARSET=utf8 COLLATE=utf8_slovenian_ci;
...
CREATE TABLE IF NOT EXISTS `student` (
  ...
  PRIMARY KEY (`id_uporabnik`),
  UNIQUE KEY `U_vpisna_stevilka` (`vpisna_stevilka`),
...
CREATE TABLE IF NOT EXISTS `zeton` (
  ...
  KEY `FK_zeton_uporabnik` (`student`),
  ...
  CONSTRAINT `FK_zeton_uporabnik` FOREIGN KEY (`student`) REFERENCES `uporabnik` (`id_uporabnik`),
